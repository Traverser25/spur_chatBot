...
// ---------------- API Endpoints ----------------
const CHAT_URL = "http://16.171.236.87/api/chat";
const HISTORY_URL = "http://16.171.236.87/api/chat/history";
...
"hi",
  ...
  "what is adrees and how can i contact u?"
];
